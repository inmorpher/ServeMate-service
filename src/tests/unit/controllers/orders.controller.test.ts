...
describe('OrdersController', () => {
  ...
  describe('getOrders', () => {
    it('should return a list of orders successfully', async () => {
      ...
      const req = mockRequest({}, { page: 1, pageSize: 10 }) as TypedRequest<{}, OrderSearchCriteria, {}>;
  ...
  describe('createOrder', () => {
    it('should create an order successfully', async () => {
      const req = mockRequest({}, {}, { tableNumber: 5, guestsCount: 2 }) as TypedRequest<{}, {}, OrderCreateDTO>;
  ...
  describe('updateOrderItems', () => {
    it('should update order items successfully', async () => {
      ...
      const req = mockRequest({ id: 1 }, {}, updateBody) as TypedRequest<{ id: number }, {}, OrderUpdateItems>;
    ...
    it('should handle errors when updating order items', async () => {
      ...
      const req = mockRequest({ id: 1 }, {}, { foodItems: [], drinkItems: [] }) as TypedRequest<{ id: number }, {}, OrderUpdateItems>;
  ...
  describe('updateOrderProperties', () => {
    it('should update order properties successfully', async () => {
      const req = mockRequest({ id: 1 }, {}, { status: 'COMPLETED' as const }) as TypedRequest<{ id: number }, {}, OrderUpdateProps>;
    ...
    it('should handle errors when updating order properties', async () => {
      const error = new Error('Update failed');
      const req = mockRequest({ id: 1 }, {}, { status: 'COMPLETED' }) as TypedRequest<{ id: number }, {}, OrderUpdateProps>;
  ...
  describe('orderItemsPrint', () => {
    it('should print order items successfully', async () => {
      ...
      const req = mockRequest({ id: 1 }, {}, { ids: [1, 2, 3] }) as TypedRequest<{ id: number }, {}, { ids: number[] }>;
      ...
      expect(ordersController['ok']).toHaveBeenCalledWith(res, mockPrintResult);
    });

    it('should handle errors when printing order items', async () => {
      const error = new Error('Printing failed');
      const req = mockRequest({ id: 1 }, {}, { ids: [1, 2, 3] }) as TypedRequest<{}, {}, { ids: number[] }>;
  ...
  describe('orderItemsCall', () => {
    it('should call order items successfully', async () => {
      ...
      const req = mockRequest({ id: 1 }, {}, { orderItemsIds: [1, 2, 3] }) as TypedRequest<{ id: number }, {}, { orderItemsIds: number[] }>;
      ...
      expect(ordersController['ok']).toHaveBeenCalledWith(res, mockCallResult);
    });

    it('should handle errors when calling order items', async () => {
      const error = new Error('Calling failed');
      const req = mockRequest({ id: 1 }, {}, { orderItemsIds: [1, 2, 3] }) as TypedRequest<{}, {}, { orderItemsIds: number[] }>;
  ...
  describe('deleteOrder', () => {
    it('should delete an order successfully', async () => {
      ...
      ordersService.delete.mockResolvedValue(true);

      await ordersController.deleteOrder(req, res as Response, next);

      expect(ordersService.delete).toHaveBeenCalledWith(1);
      expect(ordersController['ok']).toHaveBeenCalledWith(res, `Order with id ${req.params.id} deleted successfully`);
    });
